...
letters<-read.csv("E:/Data Science/SVM/letters.csv")
View(letters)
table(letters$lettr)
...
pred_model1 <- predict(model1,newdata=letters_test)
mean(pred_model1==letters_test$lettr) # 83.925
