#setwd("D:/ML/R/KNN")
library(readr)
wbcd<-read.csv("E://Excelr Data//Datasets//KNN//wbcd.csv")
View(wbcd)
str(wbcd)
dim(wbcd)
...
wbcd_train_labels<-wbcd[1:469,1] # train labels
View(wbcd_train_labels)
class(wbcd_train_labels) # factor
